...
<head>
	...
	<title>Aung San Suu Kyi, May, CSC 170 Project 3</title>
</head>
...
<?php include "inc/nav.inc";?>
	...
	<article>
		...
		<h1 id="heading">Aung San Suu Kyi</h1>
		...
		<div class="scalable">
			...
			<figure>
					...
					<img 
						...
						src="images/pic2.jpg" alt="Aung San Suu Kyi" 

						onmouseover="this.src='images/pic1.jpg'" 
						onmouseout="this.src='images/pic2.jpg'" 
		...
		<div class="scalable">
			...
			<figure>
				...
				<img
					 ...
					 src="images/pic3.jpg" alt="Aung San Suu Kyi 3" 

					onmouseover="this.src='images/pic5.jpg'" 

					onmouseout="this.src='images/pic3.jpg'" >

				<figcaption>Young Suu Kyi</figcaption>
	...
	<aside>
				...
				<h2>Periods Under Detentions</h2>
		...
		<table>
				...
				<tr>
					...
					<td>Placed under house arrest.</td>
				...
				<tr>
					...
					<td>Released after 19 months</td>
				...
				<tr>
					...
					Arrested following the Depayin massacre, she was held in secret detention for more than three months before being returned to house arrest
				...
				<tr>
					...
					House arrest extended by one year despite a direct appeal from U.N. Secretary-General Kofi Annan to General Than Shwe.
				...
				<tr>
					...
					<td>
						...
						House arrest extended for another year, which is illegal under both international law and Burma's own law.
	...
	<div class="scalable">
		...
		<figure>
			...
			<img 
				...
				src="images/pic7.jpg" alt="Aung San Suu Kyi 8" 

				onmouseover="this.src='images/pic8.jpg'" 

				onmouseout="this.src='images/pic7.jpg'" 

			>

			<figcaption>Daw Suu giving speech</figcaption>
		...
		<ul>
			...
			<li><a href="https://en.wikipedia.org/wiki/Freedom_from_Fear_(Aung_San_Suu_Kyi)">Freedom from Fear (1991)</a></li>

			<li><a href="https://en.wikipedia.org/wiki/Letters_from_Burma">Letters from Burma (1991)</a></li>
	...
	<div class="container2">
		...
		https://en.wikipedia.org/wiki/Freedom_from_Fear_(Aung_San_Suu_Kyi)
